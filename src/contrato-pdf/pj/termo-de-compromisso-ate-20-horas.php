...
<html lang="pt-br">
    <head>
        ...
        <title>PJ - Termo de compromisso até 20 horas</title>
    </head>
    <body>
        ...
        <div class="container-contrato">
            ...
            <div class="conteudo">
                <p>CONTRATANTE: <span class="bold"><?= $dados[0]["razao_social"] ?></span>, pessoa jurídica de direito privado, sediada à <span><?= $dados[0]["rua"] ?></span>, <span><?= $dados[0]["numero"] ?></span><span><?= !empty($dados[0]["complemento"]) ? " - " . $dados[0]["complemento"] : "" ?></span> - <span><?= $dados[0]["bairro"] ?></span>, cep <span><?= UtilCTRL::mascaraCEP($dados[0]["cep"]) ?></span>, nesta cidade e Comarca de <span><?= ucfirst($dados[0]["cidade"]) ?></span>, Estado do <span><?= NOME_DO_ESTADO_PELA_SIGLA[$dados[0]["uf"]] ?></span>, inscrita no CNPJ sob nº <span><?= UtilCTRL::mascaraCNPJ($dados[0]["cnpj"]) ?></span>.</p>
                ...
                <p>- A carga horária de <span class="bold"><?= $dados[0]["carga_horaria_semanal"] ?> horas</span> será ministrada <b>em dias e horários a serem negociados entre professor e aluno.</b> Em caso de atraso do CONTRATANTE, o horário de término da aula não será alterado. </p>
