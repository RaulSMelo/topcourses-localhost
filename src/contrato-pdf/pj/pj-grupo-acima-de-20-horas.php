    ...
    <body>
        ...
        <div class="container-contrato">
            ...
            <div class="conteudo">
                ...
                <p>Cláusula Quinta - As aulas a que se refere este contrato, serão ministradas por pessoal especializado da CONTRATADA, nas dependências da <span class="bold"><?= $dados[0]["local_das_aulas"] ?></span> como previsto na cláusula segunda.</p>
                ...
                <p>Cláusula Sétima - A carga horária será de <span class="bold"><?= $dados[0]["carga_horaria_semanal"] ?></span> horas, e as aulas serão ministradas nos seguintes dias e horários:
