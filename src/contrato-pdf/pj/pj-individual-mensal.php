...
<html lang="pt-br">
    <head>
        ...
        <title>PJ - Individual mensal</title>
    </head>
    <body>
        ...
        <div class="container-contrato">
            ...
            <div class="conteudo">
                ...
                <p>Cláusula Terceira - Pelos serviços retro mencionados, o CONTRATANTE pagará à CONTRATADA pela instrução do funcionário, necessária durante <span><?= $dados[0]["numero_meses_por_ano"] ?></span> meses ao ano, o equivalente <span class="bold"><?= $dados[0]["qtde_parcelas"] ?></span> <b>parcelas mensais de R$</b> <span class="bold"><?= UtilCTRL::formatoMoedaBRSemSifrao($dados[0]["valor_parcela"]) ?></span>. <?= ($dados[0]["desconto"] != "") ? "<span class='bold'> Para este contrato foi concedido desconto de " . UtilCTRL::formatoMoedaBRSemSifrao($dados[0]["desconto"]) . "%.</span>" : ""  ?></p>
                <p>Parágrafo Primeiro- O valor acima refere-se ao total de horas na semana multiplicado por 4,2, que representa a média de semanas dos meses em um ano, e por R$ <span><?= UtilCTRL::formatoMoedaBRSemSifrao($dados[0]["valor_hora_aula"]) ?></span>, que é o valor da hora aula individual. Eventual alteração em o noticiado número de horas por semana, será objeto de alteração proporcional do preço.</p>
                <p>Cláusula Quarta- O valor dos serviços mencionados na cláusula terceira, retro, será reajustado anualmente, em janeiro de cada ano, com base no aumento de nossos custos, ou qualquer índice definido pelo Governo Federal. No caso deste contrato, o valor permanecerá inalterado até o término do mesmo.</p>
...
$domPDF->stream("PJ-Individual-mensal__{$razaoSocial}.pdf", ["Attachment" => false]);
